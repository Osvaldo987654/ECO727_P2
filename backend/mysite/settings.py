...
INSTALLED_APPS = [
    ...
    'rest_framework',     # Librerías externas
    'corsheaders',    # Librerías externas
    'canciones', #Agregamos la APP creada al proyecto
]
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', #Habilita CORS para permitir conexión con tu frontend
